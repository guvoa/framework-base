				...
				<?php 
					...
					foreach($items as $item){
						...
						if( !empty($item['imagen'])){
							echo '<a href="'.ABS_HTTP_URL.'MCartProducto.php?cmd=view&id='.$item['m_cart_producto_id'].'"><img '. getSrcImgScaleParams(getImgDir('m_cart_producto','imagen',50,0,false) . $item['imagen'],50,0, true ) .' alt="" border="0"></a>';
						}
						echo '
						</td>
